...
import 'package:trash_it/Widgets/CustomCell.dart';
...
class _HistoryTabPageState extends State<HistoryTabPage> {
  static final List<AmountModel> amountModel = [
    AmountModel(
        amount: "+ \$ 200. 00",
        transactionTypeText: "Pending Amount",
        amountType: AmountType.green,
        monthText: "This Month"),
    AmountModel(
        amount: "+ \$ 120. 00",
        transactionTypeText: "Due Amount",
        amountType: AmountType.green,
        monthText: "Last Month"),
    AmountModel(
        amount: "+ \$ 120. 00",
        transactionTypeText: "Recieve Transaction",
        amountType: AmountType.green,
        monthText: "February 2019"),
  ];
